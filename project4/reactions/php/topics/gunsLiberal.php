...
$getfield = '?slug=liberal-voices&owner_screen_name=allyjlevine&count=100';
$requestMethod = 'GET';
$twitter = new TwitterAPIExchange($settings);
...
foreach($tweetData as $index => $items){
     ...
     $topics = array('gun control','guns','NRA');
     $foundTopics = false;
...
if ($foundTopics == FALSE) {
    echo 'No one has been talking about this recently.';
};
